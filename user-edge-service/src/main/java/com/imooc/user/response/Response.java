...
public class Response implements Serializable {
    ...
    public static final Response USERNAME_PASSWORD_INVALID =
            new Response("1001", "username or password is error");
    ...
    public static final Response SEND_VERIFYCODE_FAILED =
            new Response("1003", "send verifyed code failed");

    public static final Response VERIFY_CODE_INVALID =
            new Response("1004", "verifyCode invalid");
